...
class TestTaskModel(unittest.TestCase): 
    def test_create_task(self):
        task = Task(1, "Task 1", "Task 1 description", False, "2023-05-01", 3)
    ...
    def test_urgency_level(self):
        task1 = Task(1, "Task 1", "Task 1 description", False, "2023-05-01", 3)
        self.assertEqual(task1.urgency_level, 3)

        with self.assertRaises(ValueError):
            Task(2, "Task 2", "Task 1 description", False, "2023-05-01", 999)
